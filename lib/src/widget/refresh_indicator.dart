...
/// always scrollable and, therefore, can trigger the [RefreshIndicator2].
///
/// A [RefreshIndicator2] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [RefreshIndicator2State], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [RefreshIndicator2] to show
...
class ColorTween extends Tween<Color> {
  ...
  @override
  Color lerp(double t) => Color.lerp(begin, end, t) as Color;
}
          ...
          child: Container(
            child: Column(
              children: [
                ...
                Text('加载中...', style: TextStyle(color: Colors.white, fontSize: 12),),
              ],
            ),
          )
