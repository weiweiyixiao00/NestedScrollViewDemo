...
class NestedScrollViewDemo extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => NestedScrollViewDemoState();
...
List<TabTitle> tabList = [
  ...
  ScrollController _scrollController = new ScrollController(keepScrollOffset: true, initialScrollOffset: 100);
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      ...
      if (!isPullDown && _scrollController.offset < 100) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('NestedScrollViewDemo', style: TextStyle(color: Colors.black),),
      ),
      body: SafeArea(
